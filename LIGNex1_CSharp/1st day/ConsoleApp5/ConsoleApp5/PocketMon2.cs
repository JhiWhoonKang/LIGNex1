...
namespace PocketMon2
{
    abstract internal class PocketMon //객체 만들 수 없음. 하위 구현클래스에서 생성
    {
        protected int hp, exp, lv;
        protected string name;

        abstract public void 밥먹기();
        abstract public void 잠자기();
        abstract public bool 놀기();
        abstract public bool 운동하기();
        abstract public void lvCheck();
